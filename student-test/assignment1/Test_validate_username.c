...
void test_validate_my_username()
{
    ...
    char * stored_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username, stored_username, "username incorrect!");
    //TEST_ASSERT_TRUE_MESSAGE(strcmp(),"AESD students, please fix me!");
}
